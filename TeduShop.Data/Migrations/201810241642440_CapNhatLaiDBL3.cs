namespace TeduShop.Data.Migrations
{
    ...
    public partial class CapNhatLaiDBL3 : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.PostCategories", "MetaDescript", c => c.String(maxLength: 256));
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.PostCategories", "MetaDescript");
