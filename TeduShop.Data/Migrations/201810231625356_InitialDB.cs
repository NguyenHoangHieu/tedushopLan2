namespace TeduShop.Data.Migrations
{
    ...
    public partial class InitialDB : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        MetaDescript = c.String(maxLength: 256),
                        Status = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                ...
                c => new
                    {
                        ...
                        TagtID = c.String(nullable: false, maxLength: 50, unicode: false),
                    })
                .PrimaryKey(t => new { t.PostID, t.TagtID })
                .ForeignKey("dbo.Posts", t => t.PostID, cascadeDelete: true)
                .ForeignKey("dbo.Tags", t => t.TagtID, cascadeDelete: true)
                .Index(t => t.PostID)
                .Index(t => t.TagtID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PostTags", "TagtID", "dbo.Tags");
            ...
            DropIndex("dbo.PostTags", new[] { "TagtID" });
